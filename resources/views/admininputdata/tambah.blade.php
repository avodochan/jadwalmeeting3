                        ...
                        <div class="bg-light text-center rounded p-4">
                            ...
                            <div class="input-group mb-3">
                                <div class="form-floating form-floating-group flex-grow-1">
                                    <input type="text" class="rounded-0 rounded-start form-control" name="email" placeholder ="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-xl-6">
                                    <div class="form-floating mb-3">
                                        <select class="form-select" id="floatingSelectGrid" aria-label="Floating label select example" name="jabatan">
                                ...
                                <div class="col-sm-12 col-xl-6">
                                    <div class="form-floating mb-3">
                                        <select class="form-select" id="floatingSelectGrid" aria-label="Floating label select example" name="hak_akses">
                                            <option selected disabled></option>
