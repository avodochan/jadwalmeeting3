...
<head>
  ...
  <!-- Favicons -->
  <link href="{{asset ('assets/optm')}}/assets/img/favicon.png" rel="icon">
  <link href="{{asset ('assets/optm')}}/assets/img/apple-touch-icon.png" rel="apple-touch-icon">
  ...
  <!-- Vendor CSS Files -->
  <link href="{{asset ('assets/optm')}}/assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <link href="{{asset ('assets/optm')}}/assets/vendor/bootstrap-icons/bootstrap-icons.css" rel="stylesheet">
  <link href="{{asset ('assets/optm')}}/assets/vendor/aos/aos.css" rel="stylesheet">
  <link href="{{asset ('assets/optm')}}/assets/vendor/glightbox/css/glightbox.min.css" rel="stylesheet">
  <link href="{{asset ('assets/optm')}}/assets/vendor/swiper/swiper-bundle.min.css" rel="stylesheet">

  <!-- Variables CSS Files. Uncomment your preferred color scheme -->
  <link href="{{asset ('assets/optm')}}/assets/css/variables.css" rel="stylesheet">
  ...
  <link href="{{asset ('assets/optm')}}/assets/css/main.css" rel="stylesheet">
...
<div class="col-xl-6 col-sm-12 d-flex">
  <section id="hero-animated" class="hero-animated d-flex align-items-center">
    <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative" data-aos="zoom-out">
      <img src="{{asset ('assets/optm')}}/assets/img/hero-carousel/hero-carousel-3.svg" class="img-fluid animated">
...
<div class="col-xl-6 col-sm-12 d-flex">
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-6 col-md-6 d-flex" data-aos="zoom-out">
            <div class="service-item position-relative">
              <div class="icon"><i class="bi bi-plus-square-fill fa-3x text-primary"></i></div>
              <h4><a href="" class="stretched-link">New Meeting</a></h4>
          ...
          <div class="col-xl-6 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="200">
            <div class="service-item position-relative">
              ...
              <h4><a href="" class="stretched-link">Join Meeting</a></h4>
          ...
          <div class="col-xl-6 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="400">
            <div class="service-item position-relative">
              <div class="icon"><i class="bi bi-question-square-fill"></i></div>
              <h4><a href="" class="stretched-link">Meeting Request</a></h4>
          ...
          <div class="col-xl-6 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="600">
            <div class="service-item position-relative">
              ...
              <h4><a href="" class="stretched-link">Meeting Setting</a></h4>
  ...
  <!-- Vendor JS Files -->
  <script src="{{asset ('assets/optm')}}/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="{{asset ('assets/optm')}}/assets/vendor/aos/aos.js"></script>
  <script src="{{asset ('assets/optm')}}/assets/vendor/glightbox/js/glightbox.min.js"></script>
  <script src="{{asset ('assets/optm')}}/assets/vendor/isotope-layout/isotope.pkgd.min.js"></script>
  <script src="{{asset ('assets/optm')}}/assets/vendor/swiper/swiper-bundle.min.js"></script>
  <script src="{{asset ('assets/optm')}}/assets/vendor/php-email-form/validate.js"></script>

  <!-- Template Main JS File -->
  <script src="{{asset ('assets/optm')}}/assets/js/main.js"></script>
